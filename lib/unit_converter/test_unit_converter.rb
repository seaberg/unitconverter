...
class TestUnitConverter < Test::Unit::TestCase
  ...
  # Tests a valid scenario for the UnitConverter class
  def test_unit_converter
    # Create a valid UnitConverter based on rules.txt
    ...
    # Make sure the typelist contains all Length rules
    ...
    # Make sure the typelist contains all Speed rules
    ...
    # Make sure the typelist contains all Weight rules
    ...
    # Make sure the typelist contains all Volume rules
  ...
  # TODO: assert_raise should check the error messages too!
